...
from indicators.smc_utils import StructureType, FairValueGap, OrderBlock
from indicators.smc_library_bridge import SMCLibraryAnalyzer as SMCAnalyzer, get_smc_analyzer
...
class SMCScalper(StrategyBase):
    ...
    def initialize(self, config: Dict[str, Any]) -> None:
        ...
        # Initialize SMC analyzer – uses smartmoneyconcepts library when available
        point = 0.1 if "XAU" in self.symbols[0] else 0.0001
        self.smc = get_smc_analyzer(
            swing_lookback=5,
